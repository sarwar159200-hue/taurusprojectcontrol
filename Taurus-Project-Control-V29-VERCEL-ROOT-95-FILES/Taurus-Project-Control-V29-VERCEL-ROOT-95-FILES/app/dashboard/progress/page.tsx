  ...
  return (
    <>
      ...
      <section className="dashboard-grid lower-grid progress-notes">
        <article className="panel"><span className="eyebrow">FORECAST METHOD</span><h2>Baseline performance forecast</h2><p>Expected finish uses approved baseline duration multiplied by the same-date SPI (Baseline ÷ Actual). No current-plan values are used.</p></article>
        <article className="panel"><span className="eyebrow">STATUS THRESHOLDS</span><h2>Controlled schedule signal</h2><div className="thresholds"><span className="green-dot">Ahead &lt; 0.99</span><span className="blue-dot">On baseline 0.99–1.01</span><span className="amber-dot">Slight delay 1.01–1.04</span><span className="red-dot">Delayed &gt; 1.04</span></div></article>
      </section>
    </>
  );
}
