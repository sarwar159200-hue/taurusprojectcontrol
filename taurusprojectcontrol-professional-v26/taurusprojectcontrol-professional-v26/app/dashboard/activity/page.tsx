...
const eventLabels: Record<string, string> = {
  ...
  "user.access_removed": "Removed user access",
  "user.invited": "Invited user",
  "import.previewed": "Validated workbook",
  "import.published": "Published workbook update",
  "notification.project_update_sent": "Sent dashboard update email",
  "notification.project_update_partial": "Partially sent dashboard update email"
};
...
function summarizeDetails(details: Record<string, unknown>) {
  const preferred = ["path", "file_name", "email", "username", "role", "method", "data_date", "recipient_count", "sent_count", "failed_count"];
