...
async function loadDocuments(supabase: SupabaseClient, versionId: string): Promise<DocumentRecordInput[]> {
  const extendedColumns = "id, document_no, title, system_division, document_type, discipline, subdiscipline, revision, purpose, first_submission_date, last_submission_date, last_response_date, last_status, current_action, review_cycles, review_cycle_days, due_date, responsible_party, overdue_days, total_running_days, hold_by_taurus_days, hold_by_enka_days, delay_analysis, transmittal_no, transmittal_date, drive_web_url, source_row";
  const legacyColumns = "id, document_no, title, system_division, document_type, discipline, subdiscipline, revision, purpose, last_submission_date, last_response_date, last_status, current_action, review_cycles, overdue_days, drive_web_url, source_row";
