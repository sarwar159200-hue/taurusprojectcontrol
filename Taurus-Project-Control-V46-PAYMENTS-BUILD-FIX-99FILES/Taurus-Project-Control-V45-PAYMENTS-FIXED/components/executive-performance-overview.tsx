  ...
  return (
    <>
      <section className="executive-metric-grid">
        ...
        <KpiCard label="SPI" value={performance.spi === null ? "—" : performance.spi.toFixed(2)} detail={t(signal)} tone={performance.signal === "ahead" ? "green" : performance.signal === "on-plan" ? "amber" : performance.signal === "slightly-behind" ? "amber" : "red"} />
