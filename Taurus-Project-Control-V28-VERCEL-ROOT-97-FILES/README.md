...
Upload the contents of this root-ready folder directly into the GitHub repository root. Keep the old folder until v26 deploys successfully. Do not upload Excel, XER, `.env` or `.env.local` files.

## C. Configure Vercel

Keep the Vercel **Root Directory** blank (repository root / `./`).
