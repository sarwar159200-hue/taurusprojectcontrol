...
```text
taurusprojectcontrol-professional-v14/
├── app/
├── components/
├── lib/
├── public/
...
Upload the extracted `taurusprojectcontrol-professional-v14` folder. Remove the old folder only after v14 deploys successfully. Do not upload Excel, XER, `.env` or `.env.local` files.
