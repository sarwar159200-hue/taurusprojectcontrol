...
assert.equal(progress.summary.baseline, 33.49);
assert.equal(progress.summary.spi, 1.04);
assert.equal(progress.summary.sv, 1.32);
assert.match(progress.summary.expectedFinish, /^\d{4}-\d{2}-\d{2}$/);
...
assert.equal(productionProgress.summary.baseline, 33.49);
assert.equal(productionProgress.summary.spi, 1.04);
assert.equal(productionProgress.summary.sv, 1.32);
