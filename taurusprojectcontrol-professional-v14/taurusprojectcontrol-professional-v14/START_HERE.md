# Taurus Project Control v14 — start here
...
Upload the extracted `taurusprojectcontrol-professional-v14` folder to the root of the GitHub repository.
...
- Every monthly and weekly reporting period is labelled. Use the horizontal chart scrollbar when the complete timeline is wider than the screen.
