...
function NavigationLinks({ items, pathname, close }: {
    ...
    <div className="app-frame">
      <aside className={`sidebar ${open ? "sidebar-open" : ""}`}>
        ...
        <nav className="side-nav">
          ...
          <NavigationLinks items={projectItems} pathname={pathname} close={() => setOpen(false)} />
          {administrationItems.length ? <span className="nav-section-label admin-label">ADMINISTRATION</span> : null}
          <NavigationLinks items={administrationItems} pathname={pathname} close={() => setOpen(false)} />
        </nav>
      ...
      <div className="main-column">
        <header className="topbar">
          ...
          <div className="topbar-actions">
            <span className="live-indicator"><i /> {dataDate ? "Published data" : "Awaiting first publish"}</span>
            <div className="date-badge"><span>DATA DATE</span><strong>{dataDate ?? "Not published"}</strong></div>
          </div>
        </header>
