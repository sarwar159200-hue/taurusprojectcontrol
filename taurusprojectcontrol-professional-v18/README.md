...
Upload the extracted `taurusprojectcontrol-professional-v18` folder. Remove the old folder only after v18 deploys successfully. Do not upload Excel, XER, `.env` or `.env.local` files.
