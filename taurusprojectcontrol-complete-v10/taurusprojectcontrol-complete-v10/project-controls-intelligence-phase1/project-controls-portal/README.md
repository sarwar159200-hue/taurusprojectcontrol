...
With the same folder-upload method used for v8, the expected repository layout is:

```text
taurusprojectcontrol-complete-v10/
└── project-controls-intelligence-phase1/
    └── project-controls-portal/
        ├── app/
        ├── components/
        ├── lib/
        ├── public/
...
Upload the extracted `taurusprojectcontrol-complete-v10` folder. Remove the old v9 folder only after v10 deploys successfully. Do not upload Excel, XER, `.env` or `.env.local` files.
...
```text
taurusprojectcontrol-complete-v10/project-controls-intelligence-phase1/project-controls-portal
```
