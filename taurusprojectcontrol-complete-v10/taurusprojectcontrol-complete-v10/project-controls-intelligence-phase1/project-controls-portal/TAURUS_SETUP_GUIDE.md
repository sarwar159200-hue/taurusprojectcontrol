# Taurus Project Control v9 — exact setup guide
...
- Root Directory: `taurusprojectcontrol-complete-v9/project-controls-intelligence-phase1/project-controls-portal`
