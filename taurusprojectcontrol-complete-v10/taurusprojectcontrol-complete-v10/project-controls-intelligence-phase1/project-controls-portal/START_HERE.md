# Taurus Project Control v10 — start here
...
Upload the extracted `taurusprojectcontrol-complete-v10` folder to the root of the GitHub repository.

GitHub must contain this exact file path:

`taurusprojectcontrol-complete-v10/project-controls-intelligence-phase1/project-controls-portal/package.json`
