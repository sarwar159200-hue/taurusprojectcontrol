...
```text
taurusprojectcontrol-complete-v9/
...
Upload the extracted `taurusprojectcontrol-complete-v9` folder. Remove the old v8 folder only after v9 deploys successfully. Do not upload Excel, XER, `.env` or `.env.local` files.
