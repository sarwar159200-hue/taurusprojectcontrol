  ...
  return (
    <>
      ...
      <section className="kpi-grid five">
        ...
        <KpiCard label="SPI" value={performance.spi === null ? "—" : performance.spi.toFixed(2)} detail={signalLabel(performance.signal)} tone={performance.signal === "ahead" ? "green" : performance.signal === "on-plan" ? "blue" : performance.signal === "slightly-behind" ? "amber" : "red"} />
