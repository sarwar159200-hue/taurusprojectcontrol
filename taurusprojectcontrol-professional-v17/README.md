...
Upload the extracted `taurusprojectcontrol-professional-v17` folder. Remove the old folder only after v17 deploys successfully. Do not upload Excel, XER, `.env` or `.env.local` files.
