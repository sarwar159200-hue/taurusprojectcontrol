...
const ku: Record<string, string> = {
  ...
  "Ahead of Schedule": "پێش پلاندانانە", "On Schedule": "لەسەر پلاندانانە", "Behind Schedule": "لە دواوی پلاندانانە", "Ahead of baseline": "لە بنچینە پێشەوەیە",
  ...
  "Ahead > 1.00": "پێشەوە > 1.00",
  "On schedule 0.98–1.00": "لە کاتی خۆیدا 0.98–1.00",
  "Slightly behind 0.95–<0.98": "کەمێک دواکەوتوو 0.95–<0.98",
  "Behind schedule < 0.95": "دواکەوتوو < 0.95",
...
const ar: Record<string, string> = {
  ...
  "PERFORMANCE CURVE": "منحنى الأداء", "Overall cumulative S-curve": "منحنى S التراكمي الكلي", "Baseline vs actual": "خط الأساس مقابل الفعلي", "CONTROL STATUS": "حالة التحكم", "Management signal": "مؤشر الإدارة", "SCHEDULE STATUS": "حالة الجدول", "Schedule status": "حالة الجدول", "Ahead of Schedule": "متقدم على الجدول", "On Schedule": "ضمن الجدول", "Behind Schedule": "متأخر عن الجدول", "Ahead of baseline": "متقدم على خط الأساس", "On baseline": "مطابق لخط الأساس", "Slightly behind baseline": "متأخر قليلاً عن خط الأساس", "Behind baseline": "متأخر عن خط الأساس", "Pending data": "بانتظار البيانات", "Total": "الإجمالي", "All": "الكل", "curves": "منحنيات", "Baseline position": "موضع خط الأساس", "Actual achieved": "الفعلي المتحقق", "Forecast variance": "انحراف التوقع", "Workbook structure recognized": "تم التعرف على هيكل المصنف",
...
// Professional EPC / Project Controls terminology overrides.
// Keep industry-standard abbreviations (SPI, SV, WBS, MDR, IFA/IFR/IFC) unchanged.
Object.assign(ku, {
  "Project Payments": "پارەدانەکانی پڕۆژە",
  "Payments": "پارەدانەکان",
  "Data Date": "بەرواری داتا",
  "Source": "سەرچاوە",
  "Export to Excel": "هەناردەکردن بۆ Excel",
  "Upload / Update Payment Excel": "بارکردن / نوێکردنەوەی Excelی پارەدان",
  "Analyze & Publish": "شیکردنەوە و بڵاوکردنەوە",
  "Total Payment Application Amount (USD)": "کۆی بڕی داواکارییەکانی پارەدان (USD)",
  "Sum of Payment Application Amount (USD) from the controlled IPA worksheet": "کۆی بڕی داواکارییەکانی پارەدان (USD) لە شیتی کۆنترۆڵکراوی IPA",
  "Original Contract Value": "بەهای سەرەتایی گرێبەست",
  "100% (Original)": "100% (سەرەتایی)",
  "Total Variation Orders": "کۆی فەرمانەکانی گۆڕانکاری",
  "Current Contract Value (Original + Variations)": "بەهای ئێستای گرێبەست (سەرەتایی + گۆڕانکارییەکان)",
  "Current Contract Value": "بەهای ئێستای گرێبەست",
  "Total Paid Amount": "کۆی بڕی پارەدراو",
  "Remaining Amount": "بڕی ماوە",
  "Payment Status": "دۆخی پارەدان",
  "Paid": "پارەدراو",
  "Paid Amount": "بڕی پارەدراو",
  "Total Contract Value": "کۆی بەهای گرێبەست",
  "Supplier Payment Summary": "پوختەی پارەدان بە پێی دابینکەر",
  "Original value, variation orders, current contract value and payments by supplier": "بەهای سەرەتایی، فەرمانەکانی گۆڕانکاری، بەهای ئێستای گرێبەست و پارەدانەکان بە پێی دابینکەر",
  "Supplier": "دابینکەر",
  "Original Contract Value (USD Eq.)": "بەهای سەرەتایی گرێبەست (هاوتای USD)",
  "Variation Orders": "فەرمانەکانی گۆڕانکاری",
  "Payment %": "ڕێژەی پارەدان %",
  "Variation Order Details": "وردەکاری فەرمانەکانی گۆڕانکاری",
  "Variation Orders Details": "وردەکاری فەرمانەکانی گۆڕانکاری",
  "Contract Adjustment": "ڕێکخستنەوەی گرێبەست",
  "Amount": "بڕ",
  "Amount (USD)": "بڕ (USD)",
  "Source File": "فایلی سەرچاوە",
  "Source Row": "ڕیزی سەرچاوە",
  "Awaiting payment workbook": "چاوەڕێی فایلی Excelی پارەدان",
  "No payment workbook has been published yet.": "هێشتا هیچ فایلی Excelی پارەدان بڵاونەکراوەتەوە.",
  "Payment data will appear here after an authorized payment controller publishes the controlled Excel workbook.": "داتای پارەدان لێرە دەردەکەوێت دوای ئەوەی کۆنترۆڵکاری ڕێپێدراوی پارەدان فایلی Excelی کۆنترۆڵکراو بڵاوبکاتەوە.",
  "Payment workbook analyzed and published successfully.": "فایلی پارەدان بە سەرکەوتوویی شیکرایەوە و بڵاوکرایەوە.",
  "Download Android App": "داگرتنی ئەپی Android",
  "Download Windows App": "داگرتنی ئەپی Windows",
  "Project Settings": "ڕێکخستنەکانی پڕۆژە",
  "System Administration": "بەڕێوەبردنی سیستەم",
  "Audit Log": "تۆماری پشکنین"
});

Object.assign(ar, {
  "Project Payments": "مدفوعات المشروع",
  "Payments": "المدفوعات",
  "Data Date": "تاريخ البيانات",
  "Source": "المصدر",
  "Export to Excel": "تصدير إلى Excel",
  "Upload / Update Payment Excel": "رفع / تحديث ملف Excel للمدفوعات",
  "Analyze & Publish": "تحليل ونشر",
  "Total Payment Application Amount (USD)": "إجمالي قيمة طلبات الدفع (دولار أمريكي)",
  "Sum of Payment Application Amount (USD) from the controlled IPA worksheet": "مجموع قيمة طلبات الدفع (دولار أمريكي) من ورقة IPA المعتمدة",
  "Original Contract Value": "القيمة الأصلية للعقد",
  "100% (Original)": "100% (الأصلية)",
  "Total Variation Orders": "إجمالي أوامر التغيير",
  "Current Contract Value (Original + Variations)": "القيمة الحالية للعقد (الأصلية + أوامر التغيير)",
  "Current Contract Value": "القيمة الحالية للعقد",
  ...
  "Supplier Payment Summary": "ملخص المدفوعات حسب المورّد",
  "Original value, variation orders, current contract value and payments by supplier": "القيمة الأصلية وأوامر التغيير والقيمة الحالية للعقد والمدفوعات حسب المورّد",
  "Supplier": "المورّد",
  "Original Contract Value (USD Eq.)": "القيمة الأصلية للعقد (المعادل بالدولار)",
  "Variation Orders": "أوامر التغيير",
  "Payment %": "نسبة الدفع %",
  "Variation Order Details": "تفاصيل أوامر التغيير",
  "Variation Orders Details": "تفاصيل أوامر التغيير",
  "Contract Adjustment": "تعديل العقد",
  "Amount": "المبلغ",
  "Amount (USD)": "المبلغ (دولار أمريكي)",
  "Source File": "الملف المصدر",
  "Source Row": "صف المصدر",
  "Awaiting payment workbook": "بانتظار ملف Excel للمدفوعات",
  "No payment workbook has been published yet.": "لم يتم نشر ملف مدفوعات حتى الآن.",
  "Payment data will appear here after an authorized payment controller publishes the controlled Excel workbook.": "ستظهر بيانات المدفوعات هنا بعد نشر ملف Excel المعتمد من قبل مسؤول المدفوعات المخوّل.",
  "Payment workbook analyzed and published successfully.": "تم تحليل ملف المدفوعات ونشره بنجاح.",
  "Download Android App": "تنزيل تطبيق Android",
  "Download Windows App": "تنزيل تطبيق Windows",
...
function translateTree(root: ParentNode, locale: Locale) {
  ...
  while (node) {
    ...
    if (parent && !parent.closest("script, style, code, pre, .language-switcher") && !parent.closest("svg")) {
      ...
      let remembered = originalText.get(textNode);

      // React can reuse the same Text node when dynamic content changes (for example
      // SPI status: Ahead -> Behind -> On Schedule). Never let the translation layer
      // restore the node's old English value. If React has written a new known source
      // string, promote that new value to the source of truth before translating it.
      const currentIsKnownSource = Boolean(ku[currentTrimmed] || ar[currentTrimmed]);
      if (remembered && currentIsKnownSource && currentTrimmed !== remembered.trim()) {
