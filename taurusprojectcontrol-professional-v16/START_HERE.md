# Taurus Project Control v16 — start here
...
Upload the extracted `taurusprojectcontrol-professional-v16` folder to the root of the GitHub repository.

GitHub must contain this exact file path:

`taurusprojectcontrol-professional-v16/package.json`
