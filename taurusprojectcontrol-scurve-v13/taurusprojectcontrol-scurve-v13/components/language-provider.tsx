...
const ar: Record<string, string> = {
  ...
  "ACTIVE PROJECT": "المشروع النشط", "Published data": "بيانات منشورة", "Awaiting first publish": "بانتظار أول نشر", "DATA DATE": "تاريخ البيانات", "Data date": "تاريخ البيانات", "Not published": "غير منشور", "Sign out": "تسجيل الخروج",
...
export function LanguageSwitcher({ compact = false }: { compact?: boolean }) {
  ...
  const options: Array<{ value: Locale; label: string; flag: React.ReactNode }> = [
    { value: "en", label: "English", flag: <span className="language-emoji">🇬🇧</span> },
    { value: "ku", label: "Kurdish Sorani", flag: <Image alt="Kurdistan Region flag" height={18} src="/flags/krg.svg" width={26} /> },
    { value: "ar", label: "Arabic", flag: <span className="language-emoji">🇮🇶</span> }
  ];
  return (
