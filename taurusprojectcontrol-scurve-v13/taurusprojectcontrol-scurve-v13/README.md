...
Upload the extracted `taurusprojectcontrol-scurve-v13` folder. Remove the old folder only after v13 deploys successfully. Do not upload Excel, XER, `.env` or `.env.local` files.
