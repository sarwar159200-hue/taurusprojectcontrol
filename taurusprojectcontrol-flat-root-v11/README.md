...
This package is the complete flat-root replacement for the Taurus Project Control portal. It uses Next.js, Vercel and Supabase.
...
Open the extracted package and upload everything inside it directly to the GitHub repository root. Do not upload the extracted folder as a wrapper. Do not upload Excel, XER, `.env` or `.env.local` files.

## C. Configure Vercel

Clear the Vercel **Root Directory** field and leave it empty. The repository root contains `package.json`.
