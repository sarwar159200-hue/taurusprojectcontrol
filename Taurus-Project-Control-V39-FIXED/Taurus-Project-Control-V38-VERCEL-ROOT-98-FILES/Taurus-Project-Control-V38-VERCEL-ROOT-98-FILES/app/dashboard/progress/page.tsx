  ...
  return (
    <>
      ...
      <section className="dashboard-grid lower-grid progress-notes">
        ...
        <article className="panel"><span className="eyebrow">STATUS THRESHOLDS</span><h2>Controlled schedule signal</h2><div className="thresholds"><span className="green-dot">Ahead of Schedule: SPI &gt; 1.00</span><span className="green-dot">On Schedule: SPI = 1.00</span><span className="red-dot">Behind Schedule: SPI &lt; 1.00</span></div></article>
      </section>
    </>
  );
}
