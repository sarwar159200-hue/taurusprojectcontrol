...
export default async function ProgressPage() {
  ...
  const m = { ...dashboardMetrics, actual: metric(summary, "actual", dashboardMetrics.actual), planned: metric(summary, "planned", dashboardMetrics.planned), spi: metric(summary, "spi", dashboardMetrics.spi), sv: metric(summary, "sv", dashboardMetrics.sv) };
  ...
  return (
    <>
      <div className="page-heading">
        ...
        <div className="segmented page-segmented"><button className="selected">Monthly</button><button>Weekly</button></div>
      </div>
      ...
      <section className="panel">
        <div className="panel-heading"><div><span className="eyebrow">OVERALL PROGRESS</span><h2>Project S-curve</h2></div><div className="segmented"><button className="selected">Overall</button><button>Engineering</button><button>Procurement</button><button>Construction</button></div></div>
