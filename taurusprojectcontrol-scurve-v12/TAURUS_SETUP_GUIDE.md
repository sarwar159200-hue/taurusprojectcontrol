# Taurus Project Control v12 — exact setup guide

## 1. GitHub folder and Vercel root

Upload `taurusprojectcontrol-scurve-v12` to the GitHub repository root. Inside that folder GitHub must contain:

`package.json`, `app/`, `components/`, `lib/`, `public/`, `supabase/` and `tests/`

In Vercel → Settings → Build and Deployment use:

- Root Directory: `taurusprojectcontrol-scurve-v12`
