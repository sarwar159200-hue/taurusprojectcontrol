...
- Excel validation for the supplied progress/MDR and schedule workbooks.
...
The final SQL result displays `default_project_id`. Copy that UUID for Vercel.
...
- The `default_project_id` returned by migration 0002.
...
DEFAULT_PROJECT_ID=THE_UUID_RETURNED_BY_0002
```
...
The portal currently validates the supplied XLSX progress/MDR workbook and schedule export. OneDrive publishing, live database versioning and native Primavera XER logic remain the next development phase.
