...
function PermissionEditor({ permissions, disabled, canGrantPayments = false, onChange }: {
  permissions: SectionPermissions;
  disabled?: boolean;
  canGrantPayments?: boolean;
      ...
      {sectionDefinitions.map((section) => (
        <label className="permission-control" key={section.key}>
          ...
          <select
            ...
            disabled={disabled || (section.key === "payments" && !canGrantPayments)}
  ...
  return (
    <section className="panel user-create-panel">
      ...
      <form className="admin-form full-width-form" onSubmit={submit}>
        ...
        <PermissionEditor canGrantPayments={currentUserRole === "super_admin"} disabled={role === "super_admin"} onChange={setPermissions} permissions={permissions} />
        {issuedPassword ? (
  ...
  return (
    <details className="user-card">
      ...
      <div className="user-editor-body">
        ...
        <PermissionEditor canGrantPayments={currentUserRole === "super_admin"} disabled={!editable || role === "super_admin"} onChange={setPermissions} permissions={permissions} />
        {editable ? (
